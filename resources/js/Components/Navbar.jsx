        ...
        <>
            ...
            <div className='navbar bg-white shadow-sm justify-between px-6 flex items-center md:h-16'>
                ...
                <div className='hidden md:flex flex-1 justify-center space-x-8'>
                    <a href='#' className='text-black hover:text-gray-500 cursor-pointer'>Home</a>
                    <a href='#' className='text-black hover:text-gray-500 cursor-pointer'>Shop</a>
                    <a href='#' className='text-black hover:text-gray-500 cursor-pointer'>About</a>
                    <a href='#' className='text-black hover:text-gray-500 cursor-pointer'>Sign Up</a>
                </div>
