...
export function SellerSidebar({ shopName, notificationCount = 0 }) {
                    ...
                    {profileOpen && (
                        ...
                        >
                            ...
                            <Link
                                ...
                                method="post"
                                as="button"
                                className="flex items-center space-x-3 p-3 rounded-xl transition-all text-red-600 hover:bg-red-50 w-full text-left"
                            >
    ...
    return (
        <>
            ...
            {/* Desktop Sidebar */}
            {!isMobile && (
                <div className="w-64 bg-white border-r border-gray-200 shadow-sm hidden md:flex md:flex-col fixed left-0 top-0 h-full z-30">
                    {sidebarContent}
                </div>
            )}
